...
#[test]
fn generate_html_output_from_simple_correct_mps_succeeds() {
...
#[test]
fn generate_html_output_from_simple_correct_mps_with_two_rhs_succeeds() {
...
#[test]
fn generate_html_output_from_simple_incorrect_mps_missing_row_in_rhs_succeeds() {
...
#[test]
fn generate_html_output_from_simple_incorrect_mps_with_undefined_variable_in_bounds_succeeds() {
...
#[test]
fn generate_html_output_with_simplex_table_from__simple_correct_mps(){
    let mps_file = fs::read_to_string(simpler::utils::tests::setup_path_to_mps("simple_correct_mps")).unwrap();
    let parsed_mps = parse_mps(&mps_file).unwrap();
    let mut html_output = HtmlOutput::with_application_header();
