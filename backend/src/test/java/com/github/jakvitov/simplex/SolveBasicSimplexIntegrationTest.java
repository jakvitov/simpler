...
public class SolveBasicSimplexIntegrationTest {
    ...
    public void solve_basic_simplex_fails_for_invalid_row_constraint() {
        String inputMps = """
                ...
                ENDATA
                """;
        SolveLpRequestDto solveLpRequestDto = new SolveLpRequestDto(inputMps, OptimisationTarget.MAX, SimplexVariant.BASIC_SIMPLEX);
        try {
    ...
    @Test
    public void solve_basic_simplex_succeeds() {
        String inputMps = """
                NAME          SIMPLELP
                ROWS
                 N  COST
